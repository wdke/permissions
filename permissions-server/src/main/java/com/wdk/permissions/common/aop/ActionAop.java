 ...
 */
package com.wdk.permissions.common.aop;

import com.wdk.permissions.common.logger.AccessLog;
import com.wdk.permissions.common.logger.TalStopWatch;
...
public class ActionAop {
    ...
    @Pointcut("execution(* com.wdk.permissions.service..*(..))")
     ...
     * @param joinPoint
     */
    @Before(value = "execution(* com.wdk.permissions.web..*(..))")
     ...
     * @param joinPoint
     */
    @AfterReturning(value = "execution(* com.wdk.permissions.web..*(..))", returning = "result")
